...
using UnityEngine;
    ...
    internal sealed class JsonParser
    {
        ...
        private object ParseNumber()
        {
            ...
            long num;
            return CreateJsonLong(out num, json, startIndex, index - startIndex);
        }
        ...
        private Token NextTokenCore()
        {
            ...
            throw new Exception(c +" Could not find token at index " + --index);
        }

        internal static long CreateJsonLong(out long num, string s, int index, int count)
        {
            num = 0;
            bool neg = false;
