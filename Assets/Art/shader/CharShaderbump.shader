  Shader "Custom/CharShader-bumped" {
    Properties {
      ...
      _IsChangeColor ("Is Change Color", Range(0,1)) = 0
      _ChangeColorValue ("Change Color Value", Range(0,1)) = 0.6
      _ChangeColor ("Change Color", Color) = (1.0,1.0,1.0,1.0)
    }
    SubShader {
      ...
      void surf (Input IN, inout SurfaceOutput o) 
      {
		...
		if (_IsChangeColor > 0)
		{
      		basecol.rgb = lerp(basecol,_ChangeColor,_ChangeColorValue);
		}
